...
onready var fps_limit = get_node(
	"/root/OptionsMenu/Control/Panel/tabs_main/main/ScrollContainer/HBoxContainer/VBoxContainer/fps_limit"
)
onready var view_distance = get_node(
	"/root/OptionsMenu/Control/Panel/tabs_main/main/ScrollContainer/HBoxContainer/VBoxContainer/view_distance"
)
onready var pixel_amount = get_node(
	"/root/OptionsMenu/Control/Panel/tabs_main/main/ScrollContainer/HBoxContainer/VBoxContainer/pixel_amount"
)
