		...
		new TransformationRuleScriptModBuilder()
			...
			.AddRule(
				new TransformationRuleBuilder()
					...
					.Matching(TransformationPatternFactory.CreateGdSnippetPattern("""PlayerData.player_options.fps_limit = [30, 60, 120, 0][$"%fpslmit".selected]"""))
					.With(
						"""
            ...
            .AddRule(
                new TransformationRuleBuilder()
                    ...
                    .Do(Operation.ReplaceAll)
                    .Matching(TransformationPatternFactory.CreateGdSnippetPattern("""PlayerData.player_options.pixel = $"%pixel".selected"""))
                    .With(
                        """
            ...
            .AddRule(
                new TransformationRuleBuilder()
                    ...
                    .Do(Operation.ReplaceAll)
                    .Matching(TransformationPatternFactory.CreateGdSnippetPattern("""Globals.pixelize_amount = [1.0, 2.25, 6.0, 16.0][PlayerData.player_options.pixel]"""))
                    .With(
                        """
            ...
            .AddRule(
                new TransformationRuleBuilder()
                    ...
                    .Do(Operation.ReplaceAll)
                    .Matching(TransformationPatternFactory.CreateGdSnippetPattern("""PlayerData.player_options.view_distance = $"%viewd".selected"""))
                    .With(
                        """
        ...
        new TransformationRuleScriptModBuilder()
			...
			.AddRule(
				new TransformationRuleBuilder()
					...
					.Do(Operation.ReplaceAll)
					.Matching(TransformationPatternFactory.CreateGdSnippetPattern("""far = [8192, 250, 120, 25][PlayerData.player_options.view_distance]"""))
					.With(
						"""
